    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-8
        ...
        .cajon.color-secundario.p-4.mb-4
          p.p-4 De igual forma que en medios convencionales, la necesidad de información y medición de efectividad de la comunicación en medios digitales lleva a realizar una serie de mediciones derivadas de los indicadores que se han mencionado anteriormente y de los datos suministrados por las diferentes plataformas web.   
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-12.bg1.p-4
       .row.justify-content-center.align-items-center
        ...
        .col-sm-12.col-lg-10
          h3.mb-0.text-white.fw-bold En el video presentado a continuación, se describe de manera concreta el significado y los objetivos del término, adicionalmente se hace un acercamiento a los antecedentes de esta estrategia y su importancia para mejorar la promoción y las ventas de una empresa.
