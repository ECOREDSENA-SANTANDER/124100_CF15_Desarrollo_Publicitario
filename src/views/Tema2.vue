  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-12
        .row.justify-content-center.align-items-center
          .col-4.col-md-3.col-lg.tarj1.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Resumen]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj2.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Seguidores]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj3.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-3
            p.mb-0.text-center #[b Centro de anuncios]
            .row.mb-5.mt-4
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj4.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Me gusta]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj5.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Alcance]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj6.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-3
            p.mb-0.text-center #[b Visitas a]
            p.mb-0.text-center #[b la página]
            .row.mb-5.mt-4
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj7.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Publicaciones]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj8.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Historias]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
          .col-4.col-md-3.col-lg.tarj9.borde-redondo-f
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            p.mt-5.mb-5.text-center #[b Personas]
            .row.mb-5.mt-5
            .row.mb-5.mt-5
            .row.mb-5.mt-5
      ...
      .col-sm-12.col-md-12.col-lg-5
        ul.lista-ul.fa-ul.mb-0
          li.mb-5
            ...
            span.mb-0 #[b  Acciones en la página:] indica el número de clics en el contacto de la página y en el botón de #[em Call to Action] que esta tenga.
          li.mb-5  
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Vistas previas a la página:] indica el número de veces que las personas pasaron el #[em mouse] sobre la foto de perfil para obtener una vista previa.
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Visitas a la página:] indica el número de veces que las personas vieron el perfil de la página.
          li.mb-0
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Me gusta de la página:] indica el número de personas nuevas que dieron “me gusta” a la página, discriminados entre orgánicos y pagados.
      .col-8.col-md-8.col-lg-5
        img(src='@/assets/curso/temas/tema2/imagen4.png')

    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      .col-8.col-md-8.col-lg-5.d-none.d-lg-block
        img(src='@/assets/curso/temas/tema2/imagen5.png')
      .col-sm-12.col-md-12.col-lg-5
        ul.lista-ul.fa-ul.mb-0
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Alcance de la publicación:] indica el número de personas que vieron algunas de las publicaciones al menos una vez.
          li.mb-5  
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Alcance de la historia:] indica el número de personas que se les mostró en pantalla alguna historia de la página, diferenciando entre orgánicas, promocionales y totales.
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Recomendaciones:] indica el número de veces que otras personas recomendaron la página.
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Interacción con la publicación:] indica el número de veces que las personas interactuaron con una de las publicaciones a través de reacciones, comentarios, contenido compartido y clics.
          li.mb-0
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Nivel de respuesta:] indica el porcentaje de los mensajes que se respondieron a través de #[em Messenger ].
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-5
        ul.lista-ul.fa-ul.mb-0
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Videos:] indica el número de veces que los videos de la página fueron reproducidos por, al menos, 3 segundos, discriminado por pagados, totales y no pagados.
          li.mb-5  
            i.fas.fa-check-circle.color-chulo.mb-3
            span.mb-0 #[b  Seguidores de la página:] número de personas nuevas que comenzaron a seguir la página, distinguiendo por pagado y no pagado.
          li.mb-5
            i.fas.fa-check-circle.color-chulo.mb-3
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-12.bg1.p-4
       .row.justify-content-center.align-items-center
        ...
        .col-sm-12.col-lg-10
          h4.mb-0.text-white.fw-bold Además del resumen, Facebook permite analizar estadísticas detalladas de muchos de los datos que son más relevantes para la empresa y que permiten tomar decisiones en el desarrollo de estrategias promocionales y comerciales. Ahora, se detallarán algunas de ellas:
    ...
    .row.tarjeta--container.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg5.p-5.mb-cus
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-5.p-3(src='@/assets/curso/temas/tema2/tarjeta1/imagen1.svg')
        h2 Total de seguidores
      ...
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg6.p-5.mb-cus
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-5.p-3(src='@/assets/curso/temas/tema2/tarjeta1/imagen2.svg')
        h2.text-white Seguidores de la página
    ...
    #t_2_3.titulo-segundo.color-secundario(data-aos="zoom-in-left")
      h2 2.3  Centro de anuncios
    p Este es un componente muy importante para las empresas. Permite obtener información de los últimos 7, 30, 60 o 90 días de la actividad de los anuncios que se publiquen en la página y relacionando, además, el presupuesto invertido en dicha actividad.
    ...
    .row.justify-content-center.align-items-center(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-10
        .titulo-sexto.color-secundario
          h5 Figura 3.
          span
            |  Estadísticas de centro de anuncios
        .row.justify-content-center.bg2
          figure
    ...
    .row.tarjeta--container.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg5.p-5.mb-cus
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-3.p-3(src='@/assets/curso/temas/tema2/imagen9.svg')
        h2 Alcance
        p Se refiere al número de personas que vieron los anuncios de la página; el alcance debe diferenciarse de las impresiones que incluyen varias visualizaciones de una misma persona.
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg6.p-5.mb-cus
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-3.p-3(src='@/assets/curso/temas/tema2/imagen9.svg')
        h2.text-white Interacciones
        p.text-white  Indica el número de acciones que las personas realizan en relación con los anuncios de la página. 
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg7.p-5
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-3.p-3(src='@/assets/curso/temas/tema2/imagen9.svg')
        h2 Clics en el enlace
        p Esta métrica indica el número de clics en los enlaces del anuncio que direccionan a destinos específicos dentro y fuera de Facebook.

    Separador  
    #t_2_4.titulo-segundo.color-secundario(data-aos="zoom-in-left")
      h2 2.4  "Me gusta"
    p Esta sección de las estadísticas de Facebook muestra una de las variables más importantes para las empresas. Se puede calcular desde los últimos tres meses y ver la información día a día, permitiendo observar el progreso diario de la página en cuanto al total de “Me gusta” que esta obtiene.
    ...
    .row.tarjeta--container.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg5.p-5.mb-cus
        ...
        h2 Total de “Me gusta” de la página
        p Indica el número total de las personas que han dado “Me gusta” y el rendimiento promedio a lo largo del tiempo, muestra el total acumulado de cada día.
      .col-sm-12.col-md-12.col-lg-4.tarjeta.bgimg6.p-5.mb-cus
        .row.mb-4
          .col-6.col-md-3.col-lg-6
              img.mt-3.p-3(src='@/assets/curso/temas/tema2/imagen11.svg')
    ...
    #t_2_5.titulo-segundo.color-secundario(data-aos="zoom-in-left")
      h2 2.5  Alcance
    p Es una de las métricas más relevantes en un plan de medios y hace parte de los objetivos KPI que desde las estrategias de medios se plantean.

    .row.justify-content-center.align-items-center.bg3(data-aos="zoom-in-left")
      .col-6.col-md-4.col-lg-3
        img(src='@/assets/curso/temas/tema2/imagen12.svg')
    ...
    p Otra métrica con alto nivel de relevancia para la empresa es la cantidad de visitas que recibe la página. En este punto se pueden verificar las estadísticas por trimestres y periodos más cortos, incluso desde el mismo periodo del año anterior.
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-12.col-lg-5.mb-cus
        ...
        p.mb-0 #[b Visitas por sección:]  indica el total de visitas que tuvo cada pestaña del perfil de la página: inicio, publicaciones, fotos, videos, comunidad.
        br
        p.mb-4.bb-cus
      ...
      .col-sm-12.col-md-12.col-lg-5.mb-cus.bl-cus
    ...
    Separador  
    #t_2_7.titulo-segundo.color-secundario(data-aos="zoom-in-left")
      h2 2.7  Publicaciones
    p Es una métrica que resulta muy relevante para la empresa, tanto si la estrategia consiste en el desarrollo de una campaña o un anuncio individual.
      ...
      .col-sm-12.col-lg-12.bg1.p-4
       .row.justify-content-center.align-items-center
        .col-sm-12.col-lg-2.d-none.d-lg-block
          img(src='@/assets/curso/temas/tema1/imagen2.png', style="max-width: 60%; margin: auto;")
        .col-sm-12.col-lg-10
          h4.mb-0.text-white.fw-bold En esta sección se presentan dos tipos de datos en relación con las publicaciones; el primero es la información del momento en que están conectados los fans de la página y el segundo es el rendimiento de los tipos de publicaciones.
    ...
    .row.justify-content-center.mb-5.mt-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-4.col-lg-4.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta2/imagen1.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-5 Segmentación
              p.mb-0.text-center Indica el segmento de mercado al que se dirigió la publicación.
      .col-sm-12.col-md-4.col-lg-4.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta2/imagen2.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
      ...
      .col-sm-12.col-md-4.col-lg-4.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta2/imagen3.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-5 Interacción 
    ...
    Separador  
    #t_2_8.titulo-segundo.color-secundario(data-aos="zoom-in-left")
      h2 2.8  Historias
    ...
    .row.justify-content-center.mb-5.mt-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-3.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta3/imagen1.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-3 Tus fans
              p.mb-0.text-center Indica el total por rango de edad y sexo de las personas que vieron alguna publicación de la página.
      .col-sm-12.col-lg-3.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta3/imagen2.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-3 Tus seguidores
              p.mb-0.text-center Indica el total de las personas que siguen la página con rangos de edad y sexo.
      .col-sm-12.col-lg-3.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta3/imagen3.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-3 Personas alcanzadas
              p.mb-0.text-center Indica el número de personas a las que se les mostró contenido de la página y clasificadas por edad y sexo.
      .col-sm-12.col-lg-3.mb-cus
        .tarjeta-avatar
          img.p-3(src='@/assets/curso/temas/tema2/tarjeta3/imagen4.svg')
          .tarjeta.color-secundario-cus.w-100
            .p-4.text-center
              h4.text-center.mt-3 Personas que interactúan 
              p.mb-0.text-center Hace referencia al número de personas que hablan de la página, catalogadas por rango de edad y sexo.
      ...
      .col-sm-12.col-lg-12.bg1.p-4
       .row.justify-content-center.align-items-center
        .col-sm-12.col-lg-2.d-none.d-lg-block
          img(src='@/assets/curso/temas/tema1/imagen2.png', style="max-width: 60%; margin: auto;")
        .col-sm-12.col-lg-10
          h4.mb-0.text-white.fw-bold Adicionalmente, esta sección muestra el país de origen de las personas que siguen e interactúan con la página y las publicaciones, así como la ciudad y el idioma.
